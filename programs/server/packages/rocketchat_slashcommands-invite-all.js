...
var require = meteorInstall({"node_modules":{"meteor":{"rocketchat:slashcommands-invite-all":{"server.js":["babel-runtime/helpers/slicedToArray",function(require,exports,module){
	...
	return function () {                                                                                      // 8
		function inviteAll(command, params, item) {                                                              // 8
			...
			var regexp = /#?([\d-_\w]+)/g,                                                                          // 14
			    _regexp$exec = regexp.exec(params.trim()),                                                          // 14
			    _regexp$exec2 = (0, _slicedToArray3.default)(_regexp$exec, 2),                                      // 14
			    channel = _regexp$exec2[1];                                                                         // 14
                                                                                                           //
			if (!channel) {                                                                                         // 17
				return;                                                                                                // 18
			}                                                                                                       // 19
