		...
		var room = RocketChat.models.Rooms.findOpenByVisitorToken(visitorToken, {                                            // 20
			fields: {                                                                                                           // 21
				...
				servedBy: 1                                                                                                        // 28
                                                                                                                       ...
                                                                                                                       //
		if (room && room.length > 0) {                                                                                       // 32
			info.room = room[0];                                                                                                // 33
		}                                                                                                                    // 34
                                                                                                                       //
		var initSettings = RocketChat.Livechat.getInitSettings();                                                            // 36
		info.title = initSettings.Livechat_title;                                                                            // 38
		info.color = initSettings.Livechat_title_color;                                                                      // 39
		info.enabled = initSettings.Livechat_enabled;                                                                        // 40
		info.registrationForm = initSettings.Livechat_registration_form;                                                     // 41
		info.offlineTitle = initSettings.Livechat_offline_title;                                                             // 42
		info.offlineColor = initSettings.Livechat_offline_title_color;                                                       // 43
		info.offlineMessage = initSettings.Livechat_offline_message;                                                         // 44
		info.offlineSuccessMessage = initSettings.Livechat_offline_success_message;                                          // 45
		info.offlineUnavailableMessage = initSettings.Livechat_offline_form_unavailable;                                     // 46
		info.displayOfflineForm = initSettings.Livechat_display_offline_form;                                                // 47
		info.language = initSettings.Language;                                                                               // 48
		info.videoCall = initSettings.Livechat_videocall_enabled === true && initSettings.Jitsi_Enabled === true;            // 49
		info.transcript = initSettings.Livechat_enable_transcript;                                                           // 50
		info.transcriptMessage = initSettings.Livechat_transcript_message;                                                   // 51
		info.agentData = room && room[0] && room[0].servedBy && RocketChat.models.Users.getAgentInfo(room[0].servedBy._id);  // 53
		RocketChat.models.LivechatTrigger.findEnabled().forEach(function (trigger) {                                         // 55
			info.triggers.push(_.pick(trigger, '_id', 'actions', 'conditions'));                                                // 56
		});                                                                                                                  // 57
		RocketChat.models.LivechatDepartment.findEnabledWithAgents().forEach(function (department) {                         // 59
			info.departments.push(department);                                                                                  // 60
		});                                                                                                                  // 61
		info.online = RocketChat.models.Users.findOnlineAgents().count() > 0;                                                // 63
		return info;                                                                                                         // 65
	}                                                                                                                     // 66
});                                                                                                                    // 1
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
Meteor.methods({                                                                                                       // 1
	sendMessageLivechat: function (message) {                                                                             // 2
		...
		return RocketChat.Livechat.sendMessage({                                                                             // 16
			guest: guest,                                                                                                       // 16
			message: message                                                                                                    // 16
		});                                                                                                                  // 16
	}                                                                                                                     // 17
...
},"sendTranscript.js":["moment",function(require,exports,module){
...
RocketChat.models.Rooms.findByVisitorId = function (visitorId) {                                                       // 110
	...
	return this.find(query);                                                                                              // 115
                                                                                                                       ...
                                                                                                                       //
RocketChat.models.Rooms.findOneOpenByVisitorId = function (visitorId) {                                                // 118
	var query = {                                                                                                         // 119
		open: true,                                                                                                          // 120
		'v._id': visitorId                                                                                                   // 121
	};                                                                                                                    // 119
	return this.findOne(query);                                                                                           // 124
};                                                                                                                     // 125
                                                                                                                       //
RocketChat.models.Rooms.setResponseByRoomId = function (roomId, response) {                                            // 127
	return this.update({                                                                                                  // 128
		_id: roomId                                                                                                          // 129
	}, {                                                                                                                  // 128
		$set: {                                                                                                              // 131
			responseBy: {                                                                                                       // 132
				_id: response.user._id,                                                                                            // 133
				username: response.user.username                                                                                   // 134
			},                                                                                                                  // 132
			responseDate: response.responseDate,                                                                                // 136
			responseTime: response.responseTime                                                                                 // 137
		},                                                                                                                   // 131
		$unset: {                                                                                                            // 139
			waitingResponse: 1                                                                                                  // 140
		}                                                                                                                    // 139
	});                                                                                                                   // 130
};                                                                                                                     // 143
                                                                                                                       //
RocketChat.models.Rooms.closeByRoomId = function (roomId, closeInfo) {                                                 // 145
	return this.update({                                                                                                  // 146
		_id: roomId                                                                                                          // 147
	}, {                                                                                                                  // 146
		$set: {                                                                                                              // 149
			closedBy: {                                                                                                         // 150
				_id: closeInfo.user._id,                                                                                           // 151
				username: closeInfo.user.username                                                                                  // 152
			},                                                                                                                  // 150
			closedAt: closeInfo.closedAt,                                                                                       // 154
			chatDuration: closeInfo.chatDuration                                                                                // 155
		},                                                                                                                   // 149
		$unset: {                                                                                                            // 157
			open: 1                                                                                                             // 158
		}                                                                                                                    // 157
                                                                                                                       ...
                                                                                                                       //
RocketChat.models.Rooms.setLabelByRoomId = function (roomId, label) {                                                  // 163
	return this.update({                                                                                                  // 164
		_id: roomId                                                                                                          // 164
	}, {                                                                                                                  // 164
		$set: {                                                                                                              // 164
			label: label                                                                                                        // 164
                                                                                                                       ...
                                                                                                                       //
RocketChat.models.Rooms.findOpenByAgent = function (userId) {                                                          // 167
	var query = {                                                                                                         // 168
		open: true,                                                                                                          // 169
		'servedBy._id': userId                                                                                               // 170
	};                                                                                                                    // 168
	return this.find(query);                                                                                              // 173
};                                                                                                                     // 174
                                                                                                                       //
RocketChat.models.Rooms.changeAgentByRoomId = function (roomId, newAgent) {                                            // 176
	var query = {                                                                                                         // 177
		_id: roomId                                                                                                          // 178
	};                                                                                                                    // 177
	var update = {                                                                                                        // 180
		$set: {                                                                                                              // 181
			servedBy: {                                                                                                         // 182
				_id: newAgent.agentId,                                                                                             // 183
				username: newAgent.username                                                                                        // 184
			}                                                                                                                   // 182
		}                                                                                                                    // 181
	};                                                                                                                    // 180
	this.update(query, update);                                                                                           // 189
};                                                                                                                     // 190
                                                                                                                       //
RocketChat.models.Rooms.saveCRMDataByRoomId = function (roomId, crmData) {                                             // 192
	var query = {                                                                                                         // 193
		_id: roomId                                                                                                          // 194
	};                                                                                                                    // 193
	var update = {                                                                                                        // 196
...
},"LivechatExternalMessage.js":["babel-runtime/helpers/classCallCheck","babel-runtime/helpers/possibleConstructorReturn","babel-runtime/helpers/inherits",function(require){
...
}],"LivechatCustomField.js":["babel-runtime/helpers/classCallCheck","babel-runtime/helpers/possibleConstructorReturn","babel-runtime/helpers/inherits",function(require){
...
}],"LivechatDepartment.js":["babel-runtime/helpers/classCallCheck","babel-runtime/helpers/possibleConstructorReturn","babel-runtime/helpers/inherits",function(require){
...
}],"LivechatDepartmentAgents.js":["babel-runtime/helpers/classCallCheck","babel-runtime/helpers/possibleConstructorReturn","babel-runtime/helpers/inherits",function(require){
...
}],"LivechatPageVisited.js":["babel-runtime/helpers/classCallCheck","babel-runtime/helpers/possibleConstructorReturn","babel-runtime/helpers/inherits",function(require){
...
}],"LivechatTrigger.js":["babel-runtime/helpers/classCallCheck","babel-runtime/helpers/possibleConstructorReturn","babel-runtime/helpers/inherits",function(require){
...
},"LivechatInquiry.js":["babel-runtime/helpers/classCallCheck","babel-runtime/helpers/possibleConstructorReturn","babel-runtime/helpers/inherits",function(require){
...
}],"LivechatOfficeHour.js":["babel-runtime/helpers/classCallCheck","babel-runtime/helpers/possibleConstructorReturn","babel-runtime/helpers/inherits","moment",function(require,exports,module){
    ...
    */                                                                                                                 //
	...
	LivechatOfficeHour.prototype.isNowWithinHours = function () {                                                         //
		function isNowWithinHours() {                                                                                        //
			// get current time on server in utc                                                                                // 45
			// var ct = moment().utc();                                                                                         // 46
			var currentTime = moment.utc(moment().utc().format('dddd:HH:mm'), 'dddd:HH:mm'); // get todays office hours from db
                                                                                                                       //
			var todaysOfficeHours = this.findOne({                                                                              // 50
				day: currentTime.format('dddd')                                                                                    // 50
			});                                                                                                                 // 50
                                                                                                                       //
			if (!todaysOfficeHours) {                                                                                           // 51
				return false;                                                                                                      // 52
			} // check if offices are open today                                                                                // 53
                                                                                                                       //
                                                                                                                       //
			if (todaysOfficeHours.open === false) {                                                                             // 56
				return false;                                                                                                      // 57
			}                                                                                                                   // 58
                                                                                                                       //
			var start = moment.utc(todaysOfficeHours.day + ':' + todaysOfficeHours.start, 'dddd:HH:mm');                        // 60
			var finish = moment.utc(todaysOfficeHours.day + ':' + todaysOfficeHours.finish, 'dddd:HH:mm'); // console.log(finish.isBefore(start));
                                                                                                                       //
			if (finish.isBefore(start)) {                                                                                       // 64
				// finish.day(finish.day()+1);                                                                                     // 65
				finish.add(1, 'days');                                                                                             // 66
			}                                                                                                                   // 67
                                                                                                                       //
			var result = currentTime.isBetween(start, finish); // inBetween  check                                              // 69
                                                                                                                       //
			return result;                                                                                                      // 72
		}                                                                                                                    // 73
                                                                                                                       //
	...
	LivechatOfficeHour.prototype.isOpeningTime = function () {                                                            //
		function isOpeningTime() {                                                                                           //
			// get current time on server in utc                                                                                // 76
			var currentTime = moment.utc(moment().utc().format('dddd:HH:mm'), 'dddd:HH:mm'); // get todays office hours from db
                                                                                                                       //
			var todaysOfficeHours = this.findOne({                                                                              // 80
				day: currentTime.format('dddd')                                                                                    // 80
			});                                                                                                                 // 80
                                                                                                                       //
			if (!todaysOfficeHours) {                                                                                           // 81
				return false;                                                                                                      // 82
			} // check if offices are open today                                                                                // 83
                                                                                                                       //
                                                                                                                       //
			if (todaysOfficeHours.open === false) {                                                                             // 86
				return false;                                                                                                      // 87
			}                                                                                                                   // 88
                                                                                                                       //
			var start = moment.utc(todaysOfficeHours.day + ':' + todaysOfficeHours.start, 'dddd:HH:mm');                        // 90
			return start.isSame(currentTime, 'minute');                                                                         // 92
		}                                                                                                                    // 93
                                                                                                                       //
	...
	LivechatOfficeHour.prototype.isClosingTime = function () {                                                            //
		function isClosingTime() {                                                                                           //
			// get current time on server in utc                                                                                // 96
			var currentTime = moment.utc(moment().utc().format('dddd:HH:mm'), 'dddd:HH:mm'); // get todays office hours from db
                                                                                                                       //
			var todaysOfficeHours = this.findOne({                                                                              // 100
				day: currentTime.format('dddd')                                                                                    // 100
			});                                                                                                                 // 100
                                                                                                                       //
			if (!todaysOfficeHours) {                                                                                           // 101
				return false;                                                                                                      // 102
			}                                                                                                                   // 103
                                                                                                                       //
			var finish = moment.utc(todaysOfficeHours.day + ':' + todaysOfficeHours.finish, 'dddd:HH:mm');                      // 105
			return finish.isSame(currentTime, 'minute');                                                                        // 107
		}                                                                                                                    // 108
                                                                                                                       //
	...
	return LivechatOfficeHour;                                                                                            //
                                                                                                                       ...
                                                                                                                       //
RocketChat.models.LivechatOfficeHour = new LivechatOfficeHour();                                                       // 111
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
RocketChat.Livechat = {                                                                                                // 4
	...
	registerGuest: function () {                                                                                          // 79
		...
		if (user) {                                                                                                          // 94
			...
			if (s.trim(email) !== '' && (existingUser = RocketChat.models.Users.findOneGuestByEmailAddress(email))) {           // 109
				...
				updateUser.$set.name = name;                                                                                       // 119
				var userData = {                                                                                                   // 121
					username: username,                                                                                               // 122
					globalRoles: ['livechat-guest'],                                                                                  // 123
					department: department,                                                                                           // 124
					type: 'visitor',                                                                                                  // 125
					joinDefaultChannels: false                                                                                        // 126
				};                                                                                                                 // 121
                                                                                                                       //
				if (this.connection) {                                                                                             // 129
					userData.userAgent = this.connection.httpHeaders['user-agent'];                                                   // 130
					userData.ip = this.connection.httpHeaders['x-real-ip'] || this.connection.clientAddress;                          // 131
					userData.host = this.connection.httpHeaders.host;                                                                 // 132
				}                                                                                                                  // 133
                                                                                                                       //
				userId = Accounts.insertUserDoc({}, userData);                                                                     // 135
                                                                                                                       //
				if (loginToken) {                                                                                                  // 137
					updateUser.$set.services = {                                                                                      // 138
						resume: {                                                                                                        // 139
							loginTokens: [loginToken]                                                                                       // 140
						}                                                                                                                // 139
					};                                                                                                                // 138
				}                                                                                                                  // 143
			}                                                                                                                   // 144
                                                                                                                       ...
                                                                                                                       //
		if (phone) {                                                                                                         // 147
			updateUser.$set.phone = [{                                                                                          // 148
				phoneNumber: phone.number                                                                                          // 149
			}];                                                                                                                 // 149
		}                                                                                                                    // 151
                                                                                                                       //
		if (email && email.trim() !== '') {                                                                                  // 153
			updateUser.$set.visitorEmails = [{                                                                                  // 154
				address: email                                                                                                     // 155
			}];                                                                                                                 // 155
		}                                                                                                                    // 157
                                                                                                                       //
		Meteor.users.update(userId, updateUser);                                                                             // 159
		return userId;                                                                                                       // 161
	},                                                                                                                    // 162
	saveGuest: function (_ref3) {                                                                                         // 164
		var _id = _ref3._id,                                                                                                 // 164
		    name = _ref3.name,                                                                                               // 164
		    email = _ref3.email,                                                                                             // 164
		    phone = _ref3.phone;                                                                                             // 164
		var updateData = {};                                                                                                 // 165
                                                                                                                       //
		if (name) {                                                                                                          // 167
			updateData.name = name;                                                                                             // 168
		}                                                                                                                    // 169
                                                                                                                       //
		if (email) {                                                                                                         // 170
			updateData.email = email;                                                                                           // 171
		}                                                                                                                    // 172
                                                                                                                       //
		if (phone) {                                                                                                         // 173
			updateData.phone = phone;                                                                                           // 174
		}                                                                                                                    // 175
                                                                                                                       //
		var ret = RocketChat.models.Users.saveGuestById(_id, updateData);                                                    // 176
		Meteor.defer(function () {                                                                                           // 178
			RocketChat.callbacks.run('livechat.saveGuest', updateData);                                                         // 179
		});                                                                                                                  // 180
		return ret;                                                                                                          // 182
	},                                                                                                                    // 183
	closeRoom: function (_ref4) {                                                                                         // 185
		var user = _ref4.user,                                                                                               // 185
		    room = _ref4.room,                                                                                               // 185
		    comment = _ref4.comment;                                                                                         // 185
		var now = new Date();                                                                                                // 186
		RocketChat.models.Rooms.closeByRoomId(room._id, {                                                                    // 187
			user: {                                                                                                             // 188
				_id: user._id,                                                                                                     // 189
				username: user.username                                                                                            // 190
			},                                                                                                                  // 188
			closedAt: now,                                                                                                      // 192
			chatDuration: (now.getTime() - room.ts) / 1000                                                                      // 193
		});                                                                                                                  // 187
		var message = {                                                                                                      // 196
			t: 'livechat-close',                                                                                                // 197
			msg: comment,                                                                                                       // 198
			groupable: false                                                                                                    // 199
		};                                                                                                                   // 196
		RocketChat.sendMessage(user, message, room);                                                                         // 202
		RocketChat.models.Subscriptions.hideByRoomIdAndUserId(room._id, user._id);                                           // 204
		RocketChat.models.Messages.createCommandWithRoomIdAndUser('promptTranscript', room._id, user);                       // 205
		Meteor.defer(function () {                                                                                           // 207
			RocketChat.callbacks.run('livechat.closeRoom', room);                                                               // 208
		});                                                                                                                  // 209
		return true;                                                                                                         // 211
	},                                                                                                                    // 212
	getInitSettings: function () {                                                                                        // 214
		var settings = {};                                                                                                   // 215
		RocketChat.models.Settings.findNotHiddenPublic(['Livechat_title', 'Livechat_title_color', 'Livechat_enabled', 'Livechat_registration_form', 'Livechat_offline_title', 'Livechat_offline_title_color', 'Livechat_offline_message', 'Livechat_offline_success_message', 'Livechat_offline_form_unavailable', 'Livechat_display_offline_form', 'Livechat_videocall_enabled', 'Jitsi_Enabled', 'Language', 'Livechat_enable_transcript', 'Livechat_transcript_message']).forEach(function (setting) {
			settings[setting._id] = setting.value;                                                                              // 234
		});                                                                                                                  // 235
		return settings;                                                                                                     // 237
	},                                                                                                                    // 238
	saveRoomInfo: function (roomData, guestData) {                                                                        // 240
		if (!RocketChat.models.Rooms.saveRoomById(roomData._id, roomData)) {                                                 // 241
			return false;                                                                                                       // 242
		}                                                                                                                    // 243
                                                                                                                       //
		Meteor.defer(function () {                                                                                           // 245
			RocketChat.callbacks.run('livechat.saveRoom', roomData);                                                            // 246
		});                                                                                                                  // 247
                                                                                                                       //
		if (!_.isEmpty(guestData.name)) {                                                                                    // 249
	...
	closeOpenChats: function (userId, comment) {                                                                          // 254
		var _this = this;                                                                                                    // 254
                                                                                                                       //
		var user = RocketChat.models.Users.findOneById(userId);                                                              // 255
		RocketChat.models.Rooms.findOpenByAgent(userId).forEach(function (room) {                                            // 256
			_this.closeRoom({                                                                                                   // 257
				user: user,                                                                                                        // 257
				room: room,                                                                                                        // 257
				comment: comment                                                                                                   // 257
	...
	forwardOpenChats: function (userId) {                                                                                 // 261
		var _this2 = this;                                                                                                   // 261
                                                                                                                       //
		RocketChat.models.Rooms.findOpenByAgent(userId).forEach(function (room) {                                            // 262
			var guest = RocketChat.models.Users.findOneById(room.v._id);                                                        // 263
                                                                                                                       //
			_this2.transfer(room, guest, {                                                                                      // 264
				departmentId: guest.department                                                                                     // 264
			});                                                                                                                 // 264
		});                                                                                                                  // 265
	},                                                                                                                    // 266
	savePageHistory: function (token, pageInfo) {                                                                         // 268
		if (pageInfo.change === RocketChat.Livechat.historyMonitorType) {                                                    // 269
			return RocketChat.models.LivechatPageVisited.saveByToken(token, pageInfo);                                          // 270
		}                                                                                                                    // 271
                                                                                                                       //
		return;                                                                                                              // 273
	},                                                                                                                    // 274
	transfer: function (room, guest, transferData) {                                                                      // 276
		var agent = void 0;                                                                                                  // 277
                                                                                                                       //
		if (transferData.userId) {                                                                                           // 279
			var user = RocketChat.models.Users.findOneById(transferData.userId);                                                // 280
			agent = {                                                                                                           // 281
				agentId: user._id,                                                                                                 // 282
				username: user.username                                                                                            // 283
			};                                                                                                                  // 281
		} else {                                                                                                             // 285
			agent = RocketChat.Livechat.getNextAgent(transferData.departmentId);                                                // 286
		}                                                                                                                    // 287
                                                                                                                       //
		var servedBy = room.servedBy;                                                                                        // 289
                                                                                                                       //
		if (agent && agent.agentId !== servedBy._id) {                                                                       // 291
			room.usernames = _.without(room.usernames, servedBy.username).concat(agent.username);                               // 292
			RocketChat.models.Rooms.changeAgentByRoomId(room._id, agent);                                                       // 294
			var subscriptionData = {                                                                                            // 296
				rid: room._id,                                                                                                     // 297
				name: guest.name || guest.username,                                                                                // 298
				alert: true,                                                                                                       // 299
				open: true,                                                                                                        // 300
				unread: 1,                                                                                                         // 301
				code: room.code,                                                                                                   // 302
				u: {                                                                                                               // 303
					_id: agent.agentId,                                                                                               // 304
					username: agent.username                                                                                          // 305
				},                                                                                                                 // 303
				t: 'l',                                                                                                            // 307
				desktopNotifications: 'all',                                                                                       // 308
				mobilePushNotifications: 'all',                                                                                    // 309
				emailNotifications: 'all'                                                                                          // 310
			};                                                                                                                  // 296
			RocketChat.models.Subscriptions.removeByRoomIdAndUserId(room._id, servedBy._id);                                    // 312
			RocketChat.models.Subscriptions.insert(subscriptionData);                                                           // 314
			RocketChat.models.Messages.createUserLeaveWithRoomIdAndUser(room._id, {                                             // 316
				_id: servedBy._id,                                                                                                 // 316
				username: servedBy.username                                                                                        // 316
			});                                                                                                                 // 316
			RocketChat.models.Messages.createUserJoinWithRoomIdAndUser(room._id, {                                              // 317
				_id: agent.agentId,                                                                                                // 317
				username: agent.username                                                                                           // 317
			});                                                                                                                 // 317
			RocketChat.Livechat.stream.emit(room._id, {                                                                         // 319
				type: 'agentData',                                                                                                 // 320
				data: RocketChat.models.Users.getAgentInfo(agent.agentId)                                                          // 321
			});                                                                                                                 // 319
			return true;                                                                                                        // 324
		}                                                                                                                    // 325
                                                                                                                       //
	...
	sendRequest: function (postData, callback) {                                                                          // 330
		var trying = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1;                                  // 330
                                                                                                                       //
		try {                                                                                                                // 331
			var options = {                                                                                                     // 332
				headers: {                                                                                                         // 333
					'X-RocketChat-Livechat-Token': RocketChat.settings.get('Livechat_secret_token')                                   // 334
				},                                                                                                                 // 333
				data: postData                                                                                                     // 336
			};                                                                                                                  // 332
			return HTTP.post(RocketChat.settings.get('Livechat_webhookUrl'), options);                                          // 338
		} catch (e) {                                                                                                        // 339
			RocketChat.Livechat.logger.webhook.error('Response error on ' + trying + ' try ->', e); // try 10 times after 10 seconds each
                                                                                                                       //
			if (trying < 10) {                                                                                                  // 342
				RocketChat.Livechat.logger.webhook.warn('Will try again in 10 seconds ...');                                       // 343
				trying++;                                                                                                          // 344
				setTimeout(Meteor.bindEnvironment(function () {                                                                    // 345
					RocketChat.Livechat.sendRequest(postData, callback, trying);                                                      // 346
				}), 10000);                                                                                                        // 347
			}                                                                                                                   // 348
		}                                                                                                                    // 349
	},                                                                                                                    // 350
	getLivechatRoomGuestInfo: function (room) {                                                                           // 352
		var visitor = RocketChat.models.Users.findOneById(room.v._id);                                                       // 353
		var agent = RocketChat.models.Users.findOneById(room.servedBy._id);                                                  // 354
		var ua = new UAParser();                                                                                             // 356
		ua.setUA(visitor.userAgent);                                                                                         // 357
		var postData = {                                                                                                     // 359
			_id: room._id,                                                                                                      // 360
			label: room.label,                                                                                                  // 361
			topic: room.topic,                                                                                                  // 362
			code: room.code,                                                                                                    // 363
			createdAt: room.ts,                                                                                                 // 364
			lastMessageAt: room.lm,                                                                                             // 365
			tags: room.tags,                                                                                                    // 366
			customFields: room.livechatData,                                                                                    // 367
			visitor: {                                                                                                          // 368
				_id: visitor._id,                                                                                                  // 369
				name: visitor.name,                                                                                                // 370
				username: visitor.username,                                                                                        // 371
				email: null,                                                                                                       // 372
				phone: null,                                                                                                       // 373
				department: visitor.department,                                                                                    // 374
				ip: visitor.ip,                                                                                                    // 375
				os: ua.getOS().name && ua.getOS().name + ' ' + ua.getOS().version,                                                 // 376
				browser: ua.getBrowser().name && ua.getBrowser().name + ' ' + ua.getBrowser().version,                             // 377
				customFields: visitor.livechatData                                                                                 // 378
			},                                                                                                                  // 368
			agent: {                                                                                                            // 380
				_id: agent._id,                                                                                                    // 381
				username: agent.username,                                                                                          // 382
				name: agent.name,                                                                                                  // 383
				email: null                                                                                                        // 384
			}                                                                                                                   // 380
		};                                                                                                                   // 359
                                                                                                                       //
		if (room.crmData) {                                                                                                  // 388
			postData.crmData = room.crmData;                                                                                    // 389
		}                                                                                                                    // 390
                                                                                                                       //
		if (visitor.visitorEmails && visitor.visitorEmails.length > 0) {                                                     // 392
			postData.visitor.email = visitor.visitorEmails[0].address;                                                          // 393
		}                                                                                                                    // 394
                                                                                                                       //
		if (visitor.phone && visitor.phone.length > 0) {                                                                     // 395
			postData.visitor.phone = visitor.phone[0].phoneNumber;                                                              // 396
		}                                                                                                                    // 397
                                                                                                                       //
		if (agent.emails && agent.emails.length > 0) {                                                                       // 399
			postData.agent.email = agent.emails[0].address;                                                                     // 400
		}                                                                                                                    // 401
                                                                                                                       //
		return postData;                                                                                                     // 403
	},                                                                                                                    // 404
	addAgent: function (username) {                                                                                       // 406
		check(username, String);                                                                                             // 407
		var user = RocketChat.models.Users.findOneByUsername(username, {                                                     // 409
			fields: {                                                                                                           // 409
				_id: 1,                                                                                                            // 409
				username: 1                                                                                                        // 409
			}                                                                                                                   // 409
                                                                                                                       ...
                                                                                                                       //
		if (!user) {                                                                                                         // 411
			throw new Meteor.Error('error-invalid-user', 'Invalid user', {                                                      // 412
				method: 'livechat:addAgent'                                                                                        // 412
			});                                                                                                                 // 412
		}                                                                                                                    // 413
                                                                                                                       //
		if (RocketChat.authz.addUserRoles(user._id, 'livechat-agent')) {                                                     // 415
			RocketChat.models.Users.setOperator(user._id, true);                                                                // 416
			RocketChat.models.Users.setLivechatStatus(user._id, 'available');                                                   // 417
			return user;                                                                                                        // 418
		}                                                                                                                    // 419
                                                                                                                       //
		return false;                                                                                                        // 421
	},                                                                                                                    // 422
	addManager: function (username) {                                                                                     // 424
		...
		if (!user) {                                                                                                         // 429
			throw new Meteor.Error('error-invalid-user', 'Invalid user', {                                                      // 430
				method: 'livechat:addManager'                                                                                      // 430
			});                                                                                                                 // 430
		}                                                                                                                    // 431
                                                                                                                       //
		if (RocketChat.authz.addUserRoles(user._id, 'livechat-manager')) {                                                   // 433
			return user;                                                                                                        // 434
		}                                                                                                                    // 435
                                                                                                                       //
		return false;                                                                                                        // 437
	},                                                                                                                    // 438
	removeAgent: function (username) {                                                                                    // 440
		check(username, String);                                                                                             // 441
		var user = RocketChat.models.Users.findOneByUsername(username, {                                                     // 443
			fields: {                                                                                                           // 443
				_id: 1                                                                                                             // 443
			}                                                                                                                   // 443
		});                                                                                                                  // 443
                                                                                                                       //
		if (!user) {                                                                                                         // 445
			throw new Meteor.Error('error-invalid-user', 'Invalid user', {                                                      // 446
				method: 'livechat:removeAgent'                                                                                     // 446
			});                                                                                                                 // 446
		}                                                                                                                    // 447
                                                                                                                       //
		if (RocketChat.authz.removeUserFromRoles(user._id, 'livechat-agent')) {                                              // 449
			RocketChat.models.Users.setOperator(user._id, false);                                                               // 450
			RocketChat.models.Users.setLivechatStatus(user._id, 'not-available');                                               // 451
			return true;                                                                                                        // 452
		}                                                                                                                    // 453
                                                                                                                       //
		return false;                                                                                                        // 455
	},                                                                                                                    // 456
	removeManager: function (username) {                                                                                  // 458
		...
		if (!user) {                                                                                                         // 463
			throw new Meteor.Error('error-invalid-user', 'Invalid user', {                                                      // 464
				method: 'livechat:removeManager'                                                                                   // 464
			});                                                                                                                 // 464
		}                                                                                                                    // 465
                                                                                                                       //
		return RocketChat.authz.removeUserFromRoles(user._id, 'livechat-manager');                                           // 467
	},                                                                                                                    // 468
	saveDepartment: function (_id, departmentData, departmentAgents) {                                                    // 470
		check(_id, Match.Maybe(String));                                                                                     // 471
		check(departmentData, {                                                                                              // 473
			enabled: Boolean,                                                                                                   // 474
			name: String,                                                                                                       // 475
			description: Match.Optional(String),                                                                                // 476
			showOnRegistration: Boolean                                                                                         // 477
		});                                                                                                                  // 473
		check(departmentAgents, [Match.ObjectIncluding({                                                                     // 480
			agentId: String,                                                                                                    // 482
			username: String                                                                                                    // 483
		})]);                                                                                                                // 481
                                                                                                                       //
		if (_id) {                                                                                                           // 487
			var department = RocketChat.models.LivechatDepartment.findOneById(_id);                                             // 488
                                                                                                                       //
			if (!department) {                                                                                                  // 489
				throw new Meteor.Error('error-department-not-found', 'Department not found', {                                     // 490
					method: 'livechat:saveDepartment'                                                                                 // 490
				});                                                                                                                // 490
			}                                                                                                                   // 491
		}                                                                                                                    // 492
                                                                                                                       //
		return RocketChat.models.LivechatDepartment.createOrUpdateDepartment(_id, departmentData, departmentAgents);         // 494
	},                                                                                                                    // 495
	removeDepartment: function (_id) {                                                                                    // 497
		check(_id, String);                                                                                                  // 498
		var department = RocketChat.models.LivechatDepartment.findOneById(_id, {                                             // 500
			fields: {                                                                                                           // 500
				_id: 1                                                                                                             // 500
			}                                                                                                                   // 500
		});                                                                                                                  // 500
                                                                                                                       //
		if (!department) {                                                                                                   // 502
			throw new Meteor.Error('department-not-found', 'Department not found', {                                            // 503
				method: 'livechat:removeDepartment'                                                                                // 503
			});                                                                                                                 // 503
		}                                                                                                                    // 504
                                                                                                                       //
		return RocketChat.models.LivechatDepartment.removeById(_id);                                                         // 506
	},                                                                                                                    // 507
	showConnecting: function () {                                                                                         // 509
		if (RocketChat.settings.get('Livechat_Routing_Method') === 'Guest_Pool') {                                           // 510
			return RocketChat.settings.get('Livechat_open_inquiery_show_connecting');                                           // 511
		} else {                                                                                                             // 512
			return false;                                                                                                       // 513
		}                                                                                                                    // 514
	}                                                                                                                     // 515
};                                                                                                                     // 4
RocketChat.Livechat.stream = new Meteor.Streamer('livechat-room');                                                     // 518
RocketChat.Livechat.stream.allowRead('logged');                                                                        // 519
RocketChat.settings.get('Livechat_history_monitor_type', function (key, value) {                                       // 521
	RocketChat.Livechat.historyMonitorType = value;                                                                       // 522
});                                                                                                                    // 523
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                       //
module.import('../imports/server/rest/departments.js');                                                                // 1
module.import('../imports/server/rest/sms.js');                                                                        // 1
module.import('../imports/server/rest/users.js');                                                                      // 1
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
Meteor.startup(function () {                                                                                           // 1
	...
	RocketChat.settings.add('Livechat_guest_count', 1, {                                                                  // 70
		type: 'int',                                                                                                         // 70
		group: 'Livechat'                                                                                                    // 70
	});                                                                                                                   // 70
	RocketChat.settings.add('Livechat_Room_Count', 1, {                                                                   // 72
		type: 'int',                                                                                                         // 73
		group: 'Livechat',                                                                                                   // 74
		i18nLabel: 'Livechat_room_count'                                                                                     // 75
	});                                                                                                                   // 72
	RocketChat.settings.add('Livechat_agent_leave_action', 'none', {                                                      // 78
		type: 'select',                                                                                                      // 79
		group: 'Livechat',                                                                                                   // 80
		values: [{                                                                                                           // 81
			key: 'none',                                                                                                        // 82
			...
			key: 'forward',                                                                                                     // 83
			i18nLabel: 'Forward'                                                                                                // 83
		}, {                                                                                                                 // 83
			key: 'close',                                                                                                       // 84
			i18nLabel: 'Close'                                                                                                  // 84
		}],                                                                                                                  // 84
		i18nLabel: 'How_to_handle_open_sessions_when_agent_goes_offline'                                                     // 86
	});                                                                                                                   // 78
	RocketChat.settings.add('Livechat_agent_leave_action_timeout', 60, {                                                  // 89
		type: 'int',                                                                                                         // 90
		group: 'Livechat',                                                                                                   // 91
		enableQuery: {                                                                                                       // 92
			_id: 'Livechat_agent_leave_action',                                                                                 // 92
			value: {                                                                                                            // 92
				$ne: 'none'                                                                                                        // 92
			}                                                                                                                   // 92
		},                                                                                                                   // 92
		i18nLabel: 'How_long_to_wait_after_agent_goes_offline',                                                              // 93
		i18nDescription: 'Time_in_seconds'                                                                                   // 94
	});                                                                                                                   // 89
	RocketChat.settings.add('Livechat_agent_leave_comment', '', {                                                         // 97
		type: 'string',                                                                                                      // 98
		group: 'Livechat',                                                                                                   // 99
		enableQuery: {                                                                                                       // 100
			_id: 'Livechat_agent_leave_action',                                                                                 // 100
			value: 'close'                                                                                                      // 100
		},                                                                                                                   // 100
		i18nLabel: 'Comment_to_leave_on_closing_session'                                                                     // 101
	});                                                                                                                   // 97
	RocketChat.settings.add('Livechat_webhookUrl', false, {                                                               // 104
		type: 'string',                                                                                                      // 105
		group: 'Livechat',                                                                                                   // 106
		section: 'CRM_Integration',                                                                                          // 107
		i18nLabel: 'Webhook_URL'                                                                                             // 108
	});                                                                                                                   // 104
	RocketChat.settings.add('Livechat_secret_token', false, {                                                             // 111
		type: 'string',                                                                                                      // 112
		group: 'Livechat',                                                                                                   // 113
		section: 'CRM_Integration',                                                                                          // 114
		i18nLabel: 'Secret_token'                                                                                            // 115
	});                                                                                                                   // 111
	RocketChat.settings.add('Livechat_webhook_on_close', false, {                                                         // 118
		type: 'boolean',                                                                                                     // 119
		group: 'Livechat',                                                                                                   // 120
		section: 'CRM_Integration',                                                                                          // 121
		i18nLabel: 'Send_request_on_chat_close'                                                                              // 122
	});                                                                                                                   // 118
	RocketChat.settings.add('Livechat_webhook_on_offline_msg', false, {                                                   // 125
		type: 'boolean',                                                                                                     // 126
		group: 'Livechat',                                                                                                   // 127
		section: 'CRM_Integration',                                                                                          // 128
		i18nLabel: 'Send_request_on_offline_messages'                                                                        // 129
	});                                                                                                                   // 125
	RocketChat.settings.add('Livechat_Knowledge_Enabled', false, {                                                        // 132
		type: 'boolean',                                                                                                     // 133
		group: 'Livechat',                                                                                                   // 134
		section: 'Knowledge_Base',                                                                                           // 135
		"public": true,                                                                                                      // 136
		i18nLabel: 'Enabled'                                                                                                 // 137
	});                                                                                                                   // 132
	RocketChat.settings.add('Livechat_Knowledge_Apiai_Key', '', {                                                         // 140
		type: 'string',                                                                                                      // 141
		group: 'Livechat',                                                                                                   // 142
		section: 'Knowledge_Base',                                                                                           // 143
		"public": true,                                                                                                      // 144
		i18nLabel: 'Apiai_Key'                                                                                               // 145
	});                                                                                                                   // 140
	RocketChat.settings.add('Livechat_Knowledge_Apiai_Language', 'en', {                                                  // 148
		type: 'string',                                                                                                      // 149
		group: 'Livechat',                                                                                                   // 150
		section: 'Knowledge_Base',                                                                                           // 151
		"public": true,                                                                                                      // 152
		i18nLabel: 'Apiai_Language'                                                                                          // 153
	});                                                                                                                   // 148
	RocketChat.settings.add('Livechat_history_monitor_type', 'url', {                                                     // 156
		type: 'select',                                                                                                      // 157
		group: 'Livechat',                                                                                                   // 158
		i18nLabel: 'Monitor_history_for_changes_on',                                                                         // 159
		values: [{                                                                                                           // 160
			key: 'url',                                                                                                         // 161
			i18nLabel: 'Page_URL'                                                                                               // 161
		}, {                                                                                                                 // 161
			key: 'title',                                                                                                       // 162
			i18nLabel: 'Page_title'                                                                                             // 162
		}]                                                                                                                   // 162
	});                                                                                                                   // 156
	RocketChat.settings.add('Livechat_Routing_Method', 'Least_Amount', {                                                  // 166
		type: 'select',                                                                                                      // 167
		group: 'Livechat',                                                                                                   // 168
		"public": true,                                                                                                      // 169
		values: [{                                                                                                           // 170
			key: 'Least_Amount',                                                                                                // 171
			i18nLabel: 'Least_Amount'                                                                                           // 171
		}, {                                                                                                                 // 171
			key: 'Guest_Pool',                                                                                                  // 172
			i18nLabel: 'Guest_Pool'                                                                                             // 172
		}]                                                                                                                   // 172
	});                                                                                                                   // 166
	RocketChat.settings.add('Livechat_guest_pool_with_no_agents', false, {                                                // 176
		type: 'boolean',                                                                                                     // 177
		group: 'Livechat',                                                                                                   // 178
		i18nLabel: 'Accept_with_no_online_agents',                                                                           // 179
		i18nDescription: 'Accept_incoming_livechat_requests_even_if_there_are_no_online_agents',                             // 180
		enableQuery: {                                                                                                       // 181
			_id: 'Livechat_Routing_Method',                                                                                     // 181
			value: 'Guest_Pool'                                                                                                 // 181
		}                                                                                                                    // 181
	});                                                                                                                   // 176
	RocketChat.settings.add('Livechat_show_queue_list_link', false, {                                                     // 184
		type: 'boolean',                                                                                                     // 185
		group: 'Livechat',                                                                                                   // 186
		"public": true,                                                                                                      // 187
		i18nLabel: 'Show_queue_list_to_all_agents'                                                                           // 188
	});                                                                                                                   // 184
	RocketChat.settings.add('Livechat_enable_office_hours', false, {                                                      // 191
		type: 'boolean',                                                                                                     // 192
		group: 'Livechat',                                                                                                   // 193
		"public": true,                                                                                                      // 194
		i18nLabel: 'Office_hours_enabled'                                                                                    // 195
	});                                                                                                                   // 191
	RocketChat.settings.add('Livechat_videocall_enabled', false, {                                                        // 198
		type: 'boolean',                                                                                                     // 199
		group: 'Livechat',                                                                                                   // 200
		"public": true,                                                                                                      // 201
		i18nLabel: 'Videocall_enabled',                                                                                      // 202
		i18nDescription: 'Beta_feature_Depends_on_Video_Conference_to_be_enabled',                                           // 203
		enableQuery: {                                                                                                       // 204
			_id: 'Jitsi_Enabled',                                                                                               // 204
			value: true                                                                                                         // 204
		}                                                                                                                    // 204
	});                                                                                                                   // 198
	RocketChat.settings.add('Livechat_enable_transcript', false, {                                                        // 207
		type: 'boolean',                                                                                                     // 208
		group: 'Livechat',                                                                                                   // 209
		"public": true,                                                                                                      // 210
		i18nLabel: 'Transcript_Enabled'                                                                                      // 211
	});                                                                                                                   // 207
	RocketChat.settings.add('Livechat_transcript_message', 'Would you like a copy of this chat emailed?', {               // 214
		type: 'string',                                                                                                      // 215
		group: 'Livechat',                                                                                                   // 216
		"public": true,                                                                                                      // 217
		i18nLabel: 'Transcript_message',                                                                                     // 218
		enableQuery: {                                                                                                       // 219
			_id: 'Livechat_enable_transcript',                                                                                  // 219
			value: true                                                                                                         // 219
		}                                                                                                                    // 219
	});                                                                                                                   // 214
	RocketChat.settings.add('Livechat_open_inquiery_show_connecting', false, {                                            // 222
		type: 'boolean',                                                                                                     // 223
		group: 'Livechat',                                                                                                   // 224
		"public": true,                                                                                                      // 225
		i18nLabel: 'Livechat_open_inquiery_show_connecting',                                                                 // 226
		enableQuery: {                                                                                                       // 227
			_id: 'Livechat_Routing_Method',                                                                                     // 227
			value: 'Guest_Pool'                                                                                                 // 227
		}                                                                                                                    // 227
	});                                                                                                                   // 222
	RocketChat.settings.add('Livechat_AllowedDomainsList', '', {                                                          // 230
		type: 'string',                                                                                                      // 231
		group: 'Livechat',                                                                                                   // 232
		"public": true,                                                                                                      // 233
		i18nLabel: 'Livechat_AllowedDomainsList',                                                                            // 234
		i18nDescription: 'Domains_allowed_to_embed_the_livechat_widget'                                                      // 235
	});                                                                                                                   // 230
});                                                                                                                    // 237
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
