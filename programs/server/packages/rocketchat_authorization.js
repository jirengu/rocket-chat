...
}},"server":{"models":{"Permissions.js":["babel-runtime/helpers/classCallCheck","babel-runtime/helpers/possibleConstructorReturn","babel-runtime/helpers/inherits",function(require){
...
}],"Roles.js":["babel-runtime/helpers/classCallCheck","babel-runtime/helpers/possibleConstructorReturn","babel-runtime/helpers/inherits",function(require){
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                            //
/* globals RocketChat */RocketChat.authz.roomAccessValidators = [function (room, user) {                    // 1
...
/* eslint no-multi-spaces: 0 */Meteor.startup(function () {                                                 // 1
	...
	{                                                                                                          // 24
		...
		_id: 'manage-assets',                                                                                     // 35
		roles: ['admin']                                                                                          // 35
	}, {                                                                                                       // 35
		_id: 'manage-emoji',                                                                                      // 36
		roles: ['admin']                                                                                          // 36
	}, {                                                                                                       // 36
		_id: 'manage-integrations',                                                                               // 37
		roles: ['admin']                                                                                          // 37
	}, {                                                                                                       // 37
		_id: 'manage-own-integrations',                                                                           // 38
		roles: ['admin', 'bot']                                                                                   // 38
	}, {                                                                                                       // 38
		_id: 'manage-oauth-apps',                                                                                 // 39
		roles: ['admin']                                                                                          // 39
	}, {                                                                                                       // 39
		_id: 'mention-all',                                                                                       // 40
		roles: ['admin', 'owner', 'moderator', 'user']                                                            // 40
	}, {                                                                                                       // 40
		_id: 'mute-user',                                                                                         // 41
		roles: ['admin', 'owner', 'moderator']                                                                    // 41
	}, {                                                                                                       // 41
		_id: 'remove-user',                                                                                       // 42
		...
		_id: 'run-migration',                                                                                     // 44
		roles: ['admin']                                                                                          // 44
	}, {                                                                                                       // 44
		_id: 'set-moderator',                                                                                     // 45
		roles: ['admin', 'owner']                                                                                 // 45
	}, {                                                                                                       // 45
		_id: 'set-owner',                                                                                         // 46
		roles: ['admin', 'owner']                                                                                 // 46
	}, {                                                                                                       // 46
		_id: 'unarchive-room',                                                                                    // 47
		roles: ['admin']                                                                                          // 47
	}, {                                                                                                       // 47
		_id: 'view-c-room',                                                                                       // 48
		roles: ['admin', 'user', 'bot']                                                                           // 48
	}, {                                                                                                       // 48
		_id: 'view-d-room',                                                                                       // 49
		roles: ['admin', 'user', 'bot']                                                                           // 49
	}, {                                                                                                       // 49
		_id: 'view-full-other-user-info',                                                                         // 50
		roles: ['admin']                                                                                          // 50
	}, {                                                                                                       // 50
		_id: 'view-history',                                                                                      // 51
		roles: ['admin', 'user']                                                                                  // 51
	}, {                                                                                                       // 51
		_id: 'view-joined-room',                                                                                  // 52
		roles: ['guest', 'bot']                                                                                   // 52
	}, {                                                                                                       // 52
		_id: 'view-join-code',                                                                                    // 53
		roles: ['admin']                                                                                          // 53
	}, {                                                                                                       // 53
		_id: 'view-logs',                                                                                         // 54
		roles: ['admin']                                                                                          // 54
	}, {                                                                                                       // 54
		_id: 'view-other-user-channels',                                                                          // 55
		roles: ['admin']                                                                                          // 55
	}, {                                                                                                       // 55
		_id: 'view-p-room',                                                                                       // 56
		roles: ['admin', 'user']                                                                                  // 56
	}, {                                                                                                       // 56
		_id: 'view-privileged-setting',                                                                           // 57
		roles: ['admin']                                                                                          // 57
	}, {                                                                                                       // 57
		_id: 'view-room-administration',                                                                          // 58
		roles: ['admin']                                                                                          // 58
	}, {                                                                                                       // 58
		_id: 'view-statistics',                                                                                   // 59
		roles: ['admin']                                                                                          // 59
	}, {                                                                                                       // 59
		_id: 'view-user-administration',                                                                          // 60
		roles: ['admin']                                                                                          // 60
	}, {                                                                                                       // 60
		_id: 'preview-c-room',                                                                                    // 61
		roles: ['admin', 'user']                                                                                  // 61
	}];                                                                                                        // 61
                                                                                                            //
	for (var _iterator = permissions, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
		...
		if (!RocketChat.models.Permissions.findOneById(permission._id)) {                                         // 65
			RocketChat.models.Permissions.upsert(permission._id, {                                                   // 66
				$set: permission                                                                                        // 66
			});                                                                                                      // 66
		}                                                                                                         // 67
	}                                                                                                          // 68
	...
	var defaultRoles = [{                                                                                      // 70
		name: 'admin',                                                                                            // 71
		scope: 'Users',                                                                                           // 71
		description: 'Admin'                                                                                      // 71
	}, {                                                                                                       // 71
		name: 'moderator',                                                                                        // 72
		scope: 'Subscriptions',                                                                                   // 72
		description: 'Moderator'                                                                                  // 72
	}, {                                                                                                       // 72
		name: 'owner',                                                                                            // 73
		scope: 'Subscriptions',                                                                                   // 73
		description: 'Owner'                                                                                      // 73
	}, {                                                                                                       // 73
		name: 'user',                                                                                             // 74
		scope: 'Users',                                                                                           // 74
		description: ''                                                                                           // 74
	...
	for (var _iterator2 = defaultRoles, _isArray2 = Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : _iterator2[Symbol.iterator]();;) {
		...
		if (_isArray2) {                                                                                          // 79
			...
			_ref2 = _i2.value;                                                                                       // 79
                                                                                                            ...
                                                                                                            //
		var role = _ref2;                                                                                         // 79
		RocketChat.models.Roles.upsert({                                                                          // 80
			_id: role.name                                                                                           // 80
		}, {                                                                                                      // 80
			$setOnInsert: {                                                                                          // 80
				scope: role.scope,                                                                                      // 80
				description: role.description || '',                                                                    // 80
				"protected": true                                                                                       // 80
			}                                                                                                        // 80
		});                                                                                                       // 80
	}                                                                                                          // 81
